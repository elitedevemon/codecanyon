...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $config['base_url']; ?>lib/nouislider/distribute/nouislider.min.css?<?php echo $config['version']; ?>">
...
<?php if( $config['environment'] == 'dev' ): ?>
    ...
    <script src="<?php echo $config['base_url']; ?>lib/popper.js/dist/umd/popper.min.js?<?php echo $config['version']; ?>"></script>
    ...
    <script src="<?php echo $config['base_url']; ?>lib/jquery-mask-plugin/dist/jquery.mask.min.js?<?php echo $config['version']; ?>"></script>
    <script src="<?php echo $config['base_url']; ?>lib/nouislider/distribute/nouislider.min.js?<?php echo $config['version']; ?>"></script>
